...
package org.ciudadfutura.colector.android;
...
import org.ciudadfutura.colector.android.utilities.ResetUtility;
...
public class ResetAppStateTestCase {
    ...
    private void setupTestSettings() throws IOException {
        ...
        assertTrue(new File(Collect.SETTINGS + "/colector.settings").createNewFile());
        assertTrue(new File(Collect.ODK_ROOT + "/colector.settings").createNewFile());
    }

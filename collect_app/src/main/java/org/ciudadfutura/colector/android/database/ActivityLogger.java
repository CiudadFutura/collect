...
package org.ciudadfutura.colector.android.database;
 ...
 *
 * The logging database will be "/sdcard/ciudadfutura/log/activityLog.db"
 *
 * Logging is enabled if the file "/sdcard/ciudadfutura/log/enabled" exists.
 *
